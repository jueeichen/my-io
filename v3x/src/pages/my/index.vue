<template>
  ...
  <view class="my">
    ...
    <view class="my-top">
      ...
      <view class="my-top-bottom">
        ...
        >
          ...
          <view class="">
            <image
              src="../../static/images/my/poster_icon@2x.png"
              class=""
            />
          </view>
    ...
    <view class="my-center">
      <view class="">
        <image
          src="../../static/images/my/payment_sign_icon@2x.png"
          class=""
        >
        </image>
      ...
      <view class="">
        <image
          src="../../static/images/my/all_order_icon@2x.png"
          class=""
        >
        </image>
...
export default {
  ...
  onShow() {
    ...
    if (userInfo && !userInfo.mobile) {//需要登录
