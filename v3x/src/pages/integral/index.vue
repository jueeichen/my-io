			...
			<view class="integral-top">
				...
				<view>
					<view class="integral-top-contet">
						<view class="integral-top-contet-top" @tap="jump('/pages/integralDetail/index')">
							<image src="https://jjlmobile.oss-cn-shenzhen.aliyuncs.com/images/miniImgList/test/images/integral.png" />
							<view class="integral-coin">{{ accountPoint }}</view>
							<view class="integral-symbol">积分</view>
							<van-icon name="arrow" class="iconfont integral-arrow" color="#fff" />
						</view>
						<view class="integral-top-contet-bottom">分享好友赚积分, 享免升学资格喔</view>
						<view class="integral-top-contet-btn" @tap="jump('/pages/poster/index')">赚积分</view>
					</view>
				</view>
			</view>
			<view class="integral-list">
				<view class="integral-list-item" v-for="(item, index) in list" :key="index">
					<image class="" src="https://jjlmobile.oss-cn-shenzhen.aliyuncs.com/images/miniImgList/test/images/school-logo.png"></image>
