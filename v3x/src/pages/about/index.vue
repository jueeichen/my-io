    ...
    <view class="about">
        ...
        <view>
            ...
            <view class="about-content">
                “我要上学123”是隶属于科畅教育的子品牌，专注于国内高等院校本科与研究生辅导咨询，为学员提供备考、报考、考试、面试、调剂等全方位服务。在强大的资源与高水平教学辅导基础加上高水平的服务，目前已经帮助5000多名同学顺利毕业。
            </view>
            <view class="about-title">
                选择我们
            </view>
            <view class="about-content">
                科畅教育目前与各大财经类院校保持密切合作，针对MBA/MPA招生与人才培养的需求，根据每个学员的特点，提供个性化、有针对性的辅导。
            </view>
            <view class="about-content">
    ...
    setup(props) {
        ...
        return {
            ...
            initData: [{
                ...
                params: {},
                showImgUrl: "https://jjlmobile.oss-cn-shenzhen.aliyuncs.com/images/miniImgList/test/images/integral-detail.png",
                sortNo: 11,
                type: "2",
            }],
            parameter: {
