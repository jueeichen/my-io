<template>
	...
	<view class="integral-detail">
		...
		<view class="integral-detail-top">
			<image src="https://jjlmobile.oss-cn-shenzhen.aliyuncs.com/images/miniImgList/test/images/integral-detail.png" />
			<view>
				<view>可用积分</view>
		...
		<view class="index-tabs" v-if="true">
			<van-tabs @change="onChange" :swipeable="true" :animated="true" :sticky="true" :offset-top="tabsHeight">
				<van-tab title="收入">
					<view class="tab-item integral-detail-list">
						<view class="integral-detail-item" v-for="(item,index) in list" :key="index">
							<view>
